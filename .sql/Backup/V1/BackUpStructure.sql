...
CREATE TABLE `detailregisterclass` (
  ...
  `midSemPoint` float DEFAULT NULL,
  `finalSemPoint` float DEFAULT NULL,
  `stt` int(11) DEFAULT NULL,
  `timeModified` varchar(255) DEFAULT NULL,
...
CREATE TABLE `registerclass` (
  ...
  `tuitionDeadline1` varchar(50) DEFAULT NULL,
  `tuitionDeadline2` varchar(50) DEFAULT NULL,
  `stt` int(11) DEFAULT NULL,
  `timeModified` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2018-12-07 14:26:20
