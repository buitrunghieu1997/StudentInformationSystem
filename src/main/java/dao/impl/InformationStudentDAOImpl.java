...
import dao.InformationStudentDAO;
 ...
 * @author vuduchiep
 */
public class InformationStudentDAOImpl implements InformationStudentDAO {
	...
	@Override
	public boolean update(int idStudent, String fullName, String address, String phone, String dateOfBith, String email) {
