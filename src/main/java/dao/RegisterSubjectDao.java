...
public interface RegisterSubjectDao {
	 ...
	 */
	boolean updateCredit(int idRegister, int credit);
	 ...
	 */
	boolean deleteRegisterSubject(int idRegister);
	 ...
	 * @return boolean neu xoa dang ki thanh cong ket qua tra ve la true nguoc lai ket qua tra ve la false
	 */
	boolean ermanentlyDeleteRegisterSubject(int idRegister);
	 ...
	 * @return
	 */
	TblSubjectregister checkRegisterSubject(int idStudent, String semester);
