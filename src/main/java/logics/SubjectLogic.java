...
public interface SubjectLogic {
	 ...
	 */
	boolean addSubject(String idSubject, int idGenre, String name, Integer creditSubject, Integer creditTuition, int length);
	 ...
	 */
	boolean deleteSubject(String idSubject);
	 ...
	 * @return boolean neu xoa hoc phan thanh cong ket qua tra ve la true nguoc lai ket qua tra ve la false
	 */
	boolean ermanentlyDeleteSubject(String idSubject);
	 ...
	 */
	boolean upateSubject(String idSubject, int idGenre, String name, Integer creditSubject, Integer creditTuition, int length);
	 ...
	 */
	TblSubject searchSubject(String idSubject);
