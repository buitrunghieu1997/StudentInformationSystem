...
public interface DetailSubjectLogic {
     ...
     * Cần validate
     */
    public boolean addDetailSubject(int idDetailSubject, String idSubject, String semester, String room, String time);
     ...
     * Cần validate
     */
    public boolean deleteDetailSubject(int idDetailSubject);
     ...
     * Cần validate
     */
    public boolean updateDetailSubject(int idDetailSubject, String idSubject, String semester, String room, String time);
     ...
     * @return
     */
    public List<TblStudent> searchStudentInDetailObject(int idDetailSubject);
}
